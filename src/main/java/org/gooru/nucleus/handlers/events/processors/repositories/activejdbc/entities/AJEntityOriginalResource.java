...
public class AJEntityOriginalResource extends Model {
  ...
  public static final List<String> ORIGINAL_RESOURCE_FIELDS =
      Arrays.asList(ID, TITLE, URL, CREATOR_ID, MODIFIER_ID, PUBLISH_DATE, PUBLIH_STATUS, NARRATION,
          DESCRIPTION, CONTENT_SUBFORMAT, METADATA, TAXONOMY, THUMBNAIL, IS_COPYRIGHT_OWNER,
          COPYRIGHT_OWNER, RESOURCE_INFO, VISIBLE_ON_PROFILE, DISPLAY_GUIDE, ACCESSIBILITY,
