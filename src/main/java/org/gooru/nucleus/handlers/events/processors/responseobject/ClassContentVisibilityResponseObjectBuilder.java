...
public class ClassContentVisibilityResponseObjectBuilder extends ResponseObject {

    public ClassContentVisibilityResponseObjectBuilder(JsonObject body, JsonObject response) {
        super(body, response);
    }
