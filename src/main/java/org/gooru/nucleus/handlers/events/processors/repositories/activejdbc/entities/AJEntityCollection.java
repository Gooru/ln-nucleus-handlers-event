...
public class AJEntityCollection extends Model {
  ...
  public static final String SELECT_COLLECTION_BY_CUL =
      "SELECT id, format FROM collection WHERE course_id = ?::uuid AND unit_id = ?::uuid AND"
  ...
  public static final List<String> COLLECTION_FIELDS = Arrays.asList(ID, COURSE_ID, UNIT_ID,
      ...
      CREATOR_SYSTEM, LICENSE, TENANT, TENANT_ROOT);
  ...
  public static final List<String> ASSESSMENT_FIELDS = Arrays.asList(ID, COURSE_ID, UNIT_ID,
      LESSON_ID, TITLE, CREATED_AT, UPDATED_AT, OWNER_ID, CREATOR_ID, MODIFIER_ID,
      ORIGINAL_CREATOR_ID, ORIGINAL_COLLECTION_ID, PARENT_COLLECTION_ID, SEQUENCE_ID, PUBLISH_DATE,
      PUBLISH_STATUS, FORMAT, THUMBNAIL, LEARNING_OBJECTIVE, COLLABORATOR, METADATA, TAXONOMY, URL,
      LOGIN_REQUIRED, SETTING, GRADING, VISIBLE_ON_PROFILE, IS_DELETED, EDITORIAL_TAGS,
