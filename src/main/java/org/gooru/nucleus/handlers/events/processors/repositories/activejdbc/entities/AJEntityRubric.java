...
public class AJEntityRubric extends Model {
  ...
  public static final List<String> FETCH_RUBRIC_FIELDS = Arrays.asList(ID, TITLE, URL, IS_REMOTE,
      DESCRIPTION, IS_RUBRIC, GRADER, CATEGORIES, FEEDBACK_GUIDANCE, OVERALL_FEEDBACK_REQUIRED,
      CREATOR_ID, MODIFIER_ID, ORIGINAL_CREATOR_ID, ORIGINAL_RUBRIC_ID, PARENT_RUBRIC_ID,
      PUBLISH_DATE, PUBLISH_STATUS, METADATA, TAXONOMY, GUT_CODES, THUMBNAIL, COURSE_ID, UNIT_ID,
      LESSON_ID, COLLECTION_ID, CONTENT_ID, SCORING, MAX_SCORE, INCREMENT, GRADER, CREATED_AT,
