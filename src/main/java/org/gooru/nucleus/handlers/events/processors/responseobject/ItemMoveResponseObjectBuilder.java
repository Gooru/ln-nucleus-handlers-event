...
public class ItemMoveResponseObjectBuilder extends ResponseObject {
  ...
  private JsonObject createPayLoadObjectStructure() {
    ...
    payloadStructure.put(EventResponseConstants.CONTENT_FORMAT,
        body.getJsonObject(EventRequestConstants.EVENT_BODY)
            .getJsonObject(EventResponseConstants.SOURCE).getString(EventResponseConstants.TYPE));
  ...
  private JsonObject getSourceStructure() {
    ...
    sourceStructure.put(EventResponseConstants.PARENT_CONTENT_ID,
        getParentContentId(sourceContent));
    sourceStructure.put(EventResponseConstants.ORIGINAL_CONTENT_ID,
        getOriginalContentId(sourceContent));
  ...
  private JsonObject getTargetStructure() {
    ...
    targetStructure.put(EventResponseConstants.ORIGINAL_CONTENT_ID,
        getOriginalContentId(targetContent));
