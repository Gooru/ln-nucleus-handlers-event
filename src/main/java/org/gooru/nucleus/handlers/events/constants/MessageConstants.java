...
public final class MessageConstants {
  ...
  public static final String MSG_OP_EVT_COLLECTION_CONTENT_REORDER =
      "event.collection.content.reorder";
  public static final String MSG_OP_EVT_COLLECTION_CONTENT_ADD = "event.collection.content.add";
  public static final String MSG_OP_EVT_COLLECTION_COLLABORATOR_UPDATE =
      "event.collection.collaborator.update";
  ...
  public static final String MSG_OP_EVT_COLLECTION_RESOURCE_TAG_AGGREGATE =
      "event.collection.resource.tag.aggregate";
  ...
  public static final String MSG_OP_EVT_EX_COLLECTION_COLLABORATOR_UPDATE =
      "event.external.collection.collaborator.update";
  ...
  public static final String MSG_OP_EVT_ASSESSMENT_CONTENT_REORDER =
      "event.assessment.content.reorder";
  public static final String MSG_OP_EVT_ASSESSMENT_COLLABORATOR_UPDATE =
      "event.assessment.collaborator.update";
  public static final String MSG_OP_EVT_ASSESSMENT_QUESTION_TAG_AGGREGATE =
      "event.assessment.question.tag.aggregate";
  ...
  public static final String MSG_OP_EVT_EX_ASSESSMENT_COLLABORATOR_UPDATE =
      "event.external.assessment.collaborator.update";
  ...
  public static final String MSG_OP_EVT_COURSE_COLLABORATOR_UPDATE =
      "event.course.collaborator.update";
  ...
  public static final String MSG_OP_EVT_CLASS_COLLABORATOR_UPDATE =
      "event.class.collaborator.update";
  ...
  public static final String MSG_OP_EVT_USER_PASSWORD_RESET_TRIGGER =
  ...
  public static final String MSG_OP_EVT_ROSTER_CLASS_STUDENT_JOIN =
      "event.roster.class.student.join";
  public static final String MSG_OP_EVT_ROSTER_CLASS_COLLABORATOR_UPDATE =
      "event.roster.class.collaborator.update";
