...
public class AJEntityContent extends Model {
  ...
  public static final String SELECT_RESOURCE =
      "SELECT id, title, url, creator_id, modifier_id, original_creator_id, original_content_id, parent_content_id, publish_date, publish_status,"
          ...
          + " is_copyright_owner, copyright_owner, info, visible_on_profile, display_guide, accessibility, is_deleted, tenant, tenant_root FROM"
          + " content WHERE id = ?::uuid AND content_format = 'resource'::content_format_type";

  public static final List<String> RESOURCE_FIELDS =
      Arrays.asList(ID, TITLE, URL, CREATOR_ID, MODIFIER_ID, ORIGINAL_CREATOR_ID,
          ORIGINAL_CONTENT_ID, PARENT_CONTENT_ID, PUBLISH_DATE, PUBLIH_STATUS, NARRATION,
          DESCRIPTION, CONTENT_FORMAT, CONTENT_SUBFORMAT, METADATA, TAXONOMY, THUMBNAIL, COURSE_ID,
          UNIT_ID, LESSON_ID, COLLECTION_ID, IS_COPYRIGHT_OWNER, COPYRIGHT_OWNER, RESOURCE_INFO,
          VISIBLE_ON_PROFILE, DISPLAY_GUIDE, ACCESSIBILITY, IS_DELETED, TENANT, TENANT_ROOT);
  ...
  public static final String SELECT_QUESTION =
      "SELECT id, title, creator_id, modifier_id, original_creator_id, original_content_id, parent_content_id, publish_date, publish_status,"
          ...
          + " lesson_id, collection_id, is_copyright_owner, copyright_owner, visible_on_profile, is_deleted, tenant, tenant_root FROM content WHERE"
          + " id = ?::uuid AND content_format = 'question'::content_format_type";

  public static final List<String> QUESTION_FIELDS = Arrays.asList(ID, TITLE, CREATOR_ID,
      MODIFIER_ID, ORIGINAL_CREATOR_ID, ORIGINAL_CONTENT_ID, PARENT_CONTENT_ID, PUBLISH_DATE,
      PUBLIH_STATUS, DESCRIPTION, CONTENT_FORMAT, CONTENT_SUBFORMAT, ANSWER, METADATA, TAXONOMY,
      HINT_EXPLANATION_DETAIL, THUMBNAIL, COURSE_ID, UNIT_ID, LESSON_ID, COLLECTION_ID,
      IS_COPYRIGHT_OWNER, COPYRIGHT_OWNER, VISIBLE_ON_PROFILE, IS_DELETED, TENANT, TENANT_ROOT);

  public static final String SELECT_CONTENT_FORMAT =
      "SELECT content_format FROM content WHERE id = ?::uuid";
