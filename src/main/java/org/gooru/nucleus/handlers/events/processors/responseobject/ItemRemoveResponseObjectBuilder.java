...
public class ItemRemoveResponseObjectBuilder extends ResponseObject {
  ...
  private JsonObject createContextStructure() {
    ...
    contextStructure.put(EventResponseConstants.ORIGINAL_CONTENT_ID,
        getOriginalContentId(response));
    contextStructure.put(EventResponseConstants.COURSE_GOORU_ID,
        eventBody.getString(EventRequestConstants.COURSE_ID));
    contextStructure.put(EventResponseConstants.UNIT_GOORU_ID,
        eventBody.getString(EventRequestConstants.UNIT_ID));
    contextStructure.put(EventResponseConstants.LESSON_GOORU_ID,
        eventBody.getString(EventRequestConstants.LESSON_ID));
