...
public class AJEntityCourse extends Model {
  ...
  public static final String SELECT_COLLABORATOR =
      "SELECT collaborator FROM course where  id = ?::uuid";

  public static final List<String> ALL_FIELDS = Arrays.asList(ID, TITLE, DESCRIPTION, OWNER_ID,
      CREATOR_ID, ORIGINAL_CREATOR_ID, MODIFIER_ID, ORIGINAL_COURSE_ID, PUBLISH_STATUS,
      PUBLISH_DATE, THUMBNAIL, METADATA, TAXONOMY, COLLABORATOR, VISIBLE_ON_PROFILE, IS_DELETED,
      CREATED_AT, UPDATED_AT, SEQUENCE_ID, SUBJECT_BUCKET, CREATOR_SYSTEM, TENANT, TENANT_ROOT);
}
