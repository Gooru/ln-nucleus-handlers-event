...
public class ItemContentAddResponseObjectBuilder extends ResponseObject {
  ...
  private JsonObject createContextStructure() {
    ...
    contentId = this.body.getJsonObject(EventRequestConstants.EVENT_BODY)
        .getString(EventRequestConstants.CONTENT_ID);
  ...
  private JsonObject getTargetStructure() {
    ...
    String parentGooruId = this.body.getJsonObject(EventRequestConstants.EVENT_BODY)
