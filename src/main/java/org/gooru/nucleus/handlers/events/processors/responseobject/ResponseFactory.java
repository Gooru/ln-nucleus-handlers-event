...
public final class ResponseFactory {
  ...
  public static JsonObject generateItemContentReorderResponse(JsonObject body,
      JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response)
        .setEventType(MessageConstants.EST_ITEM_CONTENT_REORDER).build();
  }

  public static JsonObject generateItemCollaboratorUpdateResponse(JsonObject body,
      JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response)
  ...
  public static JsonObject generateClassContentVisibleResponse(JsonObject body,
      JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response)
        .setEventType(MessageConstants.EST_CLASS_CONTENT_VISIBILITY).build();
  }

  public static JsonObject generateAssignClassToCourseResponse(JsonObject body,
      JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response)
  ...
  public static JsonObject generateFollowUnfollowProfileResponse(JsonObject body,
      JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response)
  ...
  public static JsonObject generateErrorResponse(JsonObject body) {
    return new ResponseObjectBuilder().setBody(body).setEventType(MessageConstants.EST_ERROR)
        .build();
  }
  ...
  public static JsonObject generateClassStudentRemoveResponse(JsonObject body,
      JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response)
  ...
  public static JsonObject generateResponse(JsonObject body, JsonObject response, int eventType) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response).setEventType(eventType)
        .build();
  }

  public static JsonObject generateAssociateRubricToQuestionResponse(JsonObject body,
      JsonObject response) {
    return new ResponseObjectBuilder().setBody(body).setResponse(response)
