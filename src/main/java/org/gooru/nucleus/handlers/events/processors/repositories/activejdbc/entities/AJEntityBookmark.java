...
public class AJEntityBookmark extends Model {
    ...
    public static final List<String> BOOKMARKS_FIELDS = Arrays.asList(ID, CONTENT_ID, USER_ID, CONTENT_TYPE, TITLE,
        DESCRIPTION, SEQUENCE_ID, IS_DELETED, CREATED_AT, UPDATED_AT);
}
