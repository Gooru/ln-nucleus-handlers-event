...
public class AJEntityUnit extends Model {
	...
	public static final String SELECT_UNIT = "SELECT course_id, unit_id, title, created_at, updated_at, owner_id, creator_id, modifier_id,"
	...
	public static final String SELECT_UNITS_BY_COURSE = "SELECT unit_id FROM unit WHERE course_id = ?::uuid AND is_deleted = false";
