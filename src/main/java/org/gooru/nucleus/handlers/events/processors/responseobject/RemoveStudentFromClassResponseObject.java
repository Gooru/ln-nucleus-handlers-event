...
public class RemoveStudentFromClassResponseObject extends ResponseObject {

  public RemoveStudentFromClassResponseObject(JsonObject body, JsonObject response) {
    super(body, response);
  }
